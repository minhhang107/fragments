...
async function deleteFragment(ownerId, id) {
  ...
  // Create a GET Object command to send to S3
  const bucketCommand = new DeleteObjectCommand(bucketParams);
  ...
  try {
    ...
    const { TableName, Key } = tableParams;
    logger.error({ err, TableName, Key }, 'Error deleting fragment metadata in DynamoDb');
